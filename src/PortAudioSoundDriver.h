...
public:
    ...
    PortAudioSoundDriver(std::function<void(i16 *, unsigned long)> samples_cb, long sample_rate);
     ...
     */
    void load_samples(i16 *buf, unsigned long nframes) const override;
...
private:
    ...
    std::function<void(i16 *, unsigned long)> samples_callback;
